...
void render_menu() {
	ImGui::NewFrame();
	ImGui::Begin("Assault Cube Internal", nullptr, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize);
	...
	if (ImGui::BeginTabBar("Main"))
	{
		if (ImGui::BeginTabItem("Aim"))
		{
			...
			if (hack::config::aim::aimbot)
			{
				...
				ImGui::Text("To use the aimbot, press 'F'");
			}
			ImGui::Separator();
		...
		if (ImGui::BeginTabItem("Render"))
		{
			...
			ImGui::Checkbox("Only enimies", &hack::config::render::onlyEnimies);
			ImGui::EndTabItem();
		}
		...
		{
			ImGui::Text("github : github.com/ch4daev");
			ImGui::Text("tg : t.me/ch4deav");
			ImGui::Text("version : 1.0");
#if _DEBUG
			ImGui::Text("build : debug %s",__TIMESTAMP__);
#else
			ImGui::Text("build : relese %s", __TIMESTAMP__);
#endif
			ImGui::EndTabItem();
		}
#if _DEBUG
		if (ImGui::BeginTabItem("Debug")) {
			...
			ImGui::Text("height width : %d", hack::memory::height);
